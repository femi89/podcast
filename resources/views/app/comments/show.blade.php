...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-4">
                <div class="mb-4">
                    <h5>@lang('crud.comments.inputs.podcast_id')</h5>
                    <span
                        >{{ optional($comment->podcast)->audio_url ?? '-'
                        }}</span
                    >
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.comments.inputs.guest_id')</h5>
                    <span>{{ optional($comment->guest)->name ?? '-' }}</span>
                </div>
            </div>
